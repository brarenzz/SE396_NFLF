...
<table width="75%" border="0" cellspacing="8" cellpadding="8">
  ...
  <?php
    ...
    $sqlSelect = "SELECT * FROM equip WHERE equipstate='2' ";
  ...
  echo " <td ><a href=\"editequip.php?equipID=$row[equipID] \" onclick=\"return confirm(' ต้องการแก้ไขจากระบบจริงหรือไม่ ')\">เพิ่มอุปกรณ์</a></td>";
?>

 <?php

  echo " <td ><a href=\"deleteequip.php?equipID=$row[equipID]\" onclick=\"return confirm(' ต้องการแก้ไขจากระบบจริงหรือไม่ ')\">ลบ</a></td>";
?>
